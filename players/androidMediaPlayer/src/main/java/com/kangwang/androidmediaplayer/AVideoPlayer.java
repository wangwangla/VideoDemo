...
public class AVideoPlayer  extends AbstractPlayer {
    ...
    public AVideoPlayer(Context context) {
        this(context, null);
    }
    ...
    public AVideoPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
